...
* ✅ Check out the fun **movie pictures** generated by the multi-agent systems.     
  https://github.com/nov05/gcp-adk-multiagent-systems/tree/main/adk_multiagent_systems/workflow_agents/movie_pitches
* The current status of the repo is Task 3 for `parent_and_subagents` and Task 6 for `workflow_agents`.      
